    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">驾校管理系统注册</h1>
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(https://img0.baidu.com/it/u=1552577911,2983318668&fm=253&fmt=auto&app=138&f=JPEG?w=1422&h=800);
